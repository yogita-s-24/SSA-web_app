...
function Nav() {
  ...
  return (
    <>
      <nav
        className={`sticky top-0 flex flex-col px-0 sm:flex-col md:flex-row md:bg-[#B9E9FC] md:px-4 md:py-3 `}
      >
        ...
        <div className={`relative top-0 -z-10 w-full bg-[#B9E9FC]  `}>
          <ul
            ...
            } absolute flex w-full flex-col bg-[#B9E9FC] px-8 text-sm transition-all duration-500 ease-linear md:static md:static md:top-0 md:flex-row md:justify-end md:gap-16 md:text-lg`}
          >
